...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    // Form data layout payload matching our Django model
    // Hardcoding client to '1' (your admin user ID) for this local baseline validation step
    const newJobPayload = {
      client: 1,
      title: title,
    ...
    fetch('http://127.0.0.1:8000/api/jobs/', {
      ...
      .then(createdJob => {
        // Prepend the newly created job right to the top of the feed array
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-6xl mx-auto">
        <header className="mb-10 border-b border-gray-200 pb-5">
          ...
          <p className="mt-2 text-sm text-gray-600">A high-performance full-stack proof of concept framework.</p>
        </header>

        {/* Responsive Grid Split Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          
          {/* Column 1: Post a Job Form Panel */}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm resize-none"
                  ></textarea>
                </div>
                <button
                  type="submit"
